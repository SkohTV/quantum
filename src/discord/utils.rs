...
pub fn default_embed() -> serenity::CreateEmbed {
    let (name, pfp) = match consts::MODE {
        consts::Mode::DEV => ("Quantum Dev", "https://cdn.discordapp.com/avatars/1042497340352770142/17aa48868280edeb5edda826a0e49e48?size=1024"),
        consts::Mode::RELEASE => ("Quantum", "https://cdn.discordapp.com/avatars/1033842126334742659/5235b0f44210455555f1685cac3580b9?size=1024"),
    };
